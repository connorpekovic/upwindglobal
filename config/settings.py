...
SECURE_SSL_REDIRECT = os.environ.get("DJANGO_SECURE_SSL_REDIRECT", default=False)
...
ALLOWED_HOSTS = ["127.0.0.1", "upwindglobal.com", "www.upwindglobal.com"]

# API Keys
OPENWEATHER_API_KEY = os.environ.get('OPENWEATHER_API_KEY', "false")
