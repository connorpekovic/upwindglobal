...
# in service of our Views.py, but really it could be in service of any file. Mainly, I use it to
...
# and returns the values in a Python Dictionary. This dictionary object is used as input to the legendary
